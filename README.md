...
📌 Média salarial considerando cargos Pleno, Júnior e Estagiário:

🔬 Ciência de Dados → Pleno R$ 5,8k | Júnior R$ 3,3k | Estagiário R$ 1,5k

🌐 Desenvolvimento Web → Pleno R$ 5,0k | Júnior R$ 3,8k | Estagiário R$ 1,7k

🔐 Segurança da Informação → Pleno R$ 7,2k | Júnior R$ 3,8k | Estagiário R$ 1,4k
...
🗄️ Banco de Dados também se destaca com R$ 6,8k no nível Pleno.

📈 A maior concentração de vagas está entre cargos Júnior e Pleno.

🖥️ Hard Skills mais pedidas: SQL, Python, Power BI, Java e APIs.
...
✨ Projeto desenvolvido por Ibson Vital usando Power BI
<br>
